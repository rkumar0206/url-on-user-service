...
public class UrlOnUserServiceApplication {
    ...
    //@Bean
    CommandLineRunner run(UserRepository userRepository, RoleRepository roleRepository, FollowerRepository followerRepository) {
        ...
        return args -> {
            ...
            for (int i = 0; i < userIds.size(); i++) {
                ...
                Follower follower = new Follower(null, userTemp.getUid(), i == 0 ? userIds.get(i + 1) : userIds.get(i - 1), System.currentTimeMillis());
